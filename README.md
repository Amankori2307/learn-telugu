...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/kBeT5XEdOz)
...
```sh
npx nx serve learn-telugu
```

To create a production bundle:

```sh
npx nx build learn-telugu
```

To see all available targets to run for a project, run:

```sh
npx nx show project learn-telugu
```
